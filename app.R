...
server <- function(input, output, session) {
  ...
  observeEvent(input$datafile, {
    ...
    stations_data <- tryCatch({
      read.csv("https://raw.githubusercontent.com/rarabzad/LR/main/stations.csv", stringsAsFactors = FALSE)
    }, error = function(e) NULL)
  ...
  observeEvent(input$impute, {
    ...
    if (input$fillingMethod1 == "LR") {
      ...
      source("https://raw.githubusercontent.com/rarabzad/LR/main/LR.R")
    }
